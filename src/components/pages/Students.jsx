...
<td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">{student.parent1_name || 'Not provided'}</div>
                      <div className="text-sm text-gray-500">{student.parent1_phone || student.parent1_email || 'No contact info'}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
